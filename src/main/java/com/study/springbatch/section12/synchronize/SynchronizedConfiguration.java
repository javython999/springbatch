...
public class SynchronizedConfiguration {
    ...
    @Bean
    @StepScope
    public SynchronizedItemStreamReader<AsyncItemDto> customItemReader() {
        JdbcCursorItemReader<AsyncItemDto> notThreadSafetyReader = new JdbcCursorItemReaderBuilder<AsyncItemDto>()
                .fetchSize(100)
                ...
                .build();
        return new SynchronizedItemStreamReaderBuilder<AsyncItemDto>()
    ...
    public TaskExecutor taskExecutor() {
        ...
        executor.setThreadNamePrefix("thread-safety-task-executor");
        return executor;
    }
